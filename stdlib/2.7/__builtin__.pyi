...
class bytes(basestring, Sequence[bytes]):
    ...
    def rsplit(self, sep: bytes = ..., maxsplit: int = ...) -> List[bytes]: ...
    ...
    def translate(self, table: bytes, deletechars: bytes = ...) -> bytes: ...
    ...
    def __contains__(self, o: bytes) -> bool: ...  # type: ignore
    def __eq__(self, x: object) -> bool: ...
    def __ne__(self, x: object) -> bool: ...
...
class str(bytes):
    ...
    def count(self, x: Union[bytes, unicode]) -> int: ...
    ...
    def find(self, sub: Union[bytes, unicode], start: int = ..., end: int = ...) -> int: ...
    def format(self, *args: Any, **kwargs: Any) -> str: ...
    def index(self, sub: Union[bytes, unicode], start: int = ..., end: int = ...) -> int: ...
    ...
    def lstrip(self) -> str: ...
    @overload
    def lstrip(self, chars: AnyStr) -> AnyStr: ...
    def partition(self, sep: AnyStr) -> Tuple[AnyStr, AnyStr, AnyStr]: ...  # type: ignore
    def replace(self, old: AnyStr, new: AnyStr, count: int = ...) -> AnyStr: ...
    def rfind(self, sub: unicode, start: int = ..., end: int = ...) -> int: ...  # type: ignore
    def rindex(self, sub: unicode, start: int = ..., end: int = ...) -> int: ...  # type: ignore
    @overload
    def rjust(self, width: int, fillchar: bytes = ...) -> bytes: ...
    @overload
    def rjust(self, width: int, fillchar: str = ...) -> str: ...
    def rpartition(self, sep: AnyStr) -> Tuple[AnyStr, AnyStr, AnyStr]: ...  # type: ignore
    @overload  # type: ignore
    ...
    def rstrip(self) -> str: ...
    @overload
    def rstrip(self, chars: AnyStr) -> AnyStr: ...
    @overload  # type: ignore
    def split(self, sep: bytes = ..., maxsplit: int = ...) -> List[str]: ...
    @overload
    def split(self, sep: unicode, maxsplit: int = ...) -> List[unicode]: ...
    def splitlines(self, keepends: bool = ...) -> List[str]: ...  # type: ignore
    def startswith(self, prefix: Union[unicode, Tuple[unicode, ...]]) -> bool: ...  # type: ignore
    @overload
    def strip(self, chars: bytes = ...) -> str: ...
    @overload
    def strip(self, chars: unicode) -> unicode: ...
    def swapcase(self) -> str: ...
    def title(self) -> str: ...
    @overload  # type: ignore
    def translate(self, table: AnyStr) -> AnyStr: ...
    @overload
    def translate(self, table: bytes, deletechars: bytes) -> bytes: ...
    @overload
    def translate(self, table: bytes, deletechars: str) -> bytes: ...
    @overload
    def translate(self, table: str, deletechars: bytes) -> bytes: ...
    @overload
    def translate(self, table: str, deletechars: str) -> str: ...
    def upper(self) -> str: ...
    ...
    def __contains__(self, o: Union[bytes, unicode]) -> bool: ...  # type: ignore
    def __lt__(self, x: Union[bytes, unicode]) -> bool: ...  # type: ignore
    def __le__(self, x: Union[bytes, unicode]) -> bool: ...  # type: ignore
    def __gt__(self, x: Union[bytes, unicode]) -> bool: ...  # type: ignore
    def __ge__(self, x: Union[bytes, unicode]) -> bool: ...  # type: ignore
...
class bytearray(MutableSequence[int]):
    ...
    @overload
    def __init__(self, x: bytes, encoding: unicode,
                 errors: unicode = ...) -> None: ...
    @overload
    ...
    def rsplit(self, sep: bytes = ..., maxsplit: int = ...) -> List[bytearray]: ...
    def rstrip(self, chars: bytes = ...) -> bytearray: ...
    def split(self, sep: bytes = ..., maxsplit: int = ...) -> List[bytearray]: ...
    ...
    @overload
    def __setitem__(self, s: slice, x: Union[Sequence[int], bytes]) -> None: ...
    def __setslice__(self, start: int, stop: int, x: Union[Sequence[int], bytes]) -> None: ...
